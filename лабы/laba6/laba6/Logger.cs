...
namespace laba6
{
    public class Logger
    {
        ...
        {
            using StreamWriter streamWriter = new StreamWriter("C:\\Users\\USER\\Desktop\\лабы\\3сем\\ооп\\laba6\\laba6\\log.txt", false);
        ...
        {
            using StreamWriter streamWriter = new StreamWriter("C:\\Users\\USER\\Desktop\\лабы\\3сем\\ооп\\laba6\\laba6\\log.txt", true);
            streamWriter.WriteLine("------------------------------------------------");
            streamWriter.WriteLine();
